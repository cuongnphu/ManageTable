...
<title>Manage Information Embroidery</title>
	...
	<table class="table table-bordered" style="width: 600px">
		...
		<c:forEach items="${embroideryList}" var="embroid">
			<tr>
				...
				<td width="60" align="center"><a class="btn-primary btn-sm" href="${embroid.table_id}/edit/${embroid.id}">Edit</a> | <a class="btn-primary btn-sm" href="${embroid.table_id}/delete/${embroid.id}">Delete</a></td>
			</tr>
		</c:forEach>
	</table>
